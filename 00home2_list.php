...
if(!empty($_GET["action"])) {
    switch($_GET["action"]) {
        ...
        case "add_topping":
            if(!empty($_POST["quantity"])) {
                $productByCode_topping = $db_handle->runQuery("SELECT * FROM food_toppings WHERE food_toppings_code ='" . $_GET["code"] . "'");

                $itemArray = array($productByCode_topping[0]["food_toppings_code"]=>array('name'=>$productByCode_topping[0]["toppings_name"], 
                                                                                        'code'=>$productByCode_topping[0]["food_toppings_code"], 
                                                                                        'quantity'=>$_POST["quantity"],
                                                                                        'price'=>$productByCode_topping[0]["toppings_price"], 
                                                                                        'image'=>$productByCode_topping[0]["toppings_pic"]));
                                                        
                                                                    
                if(!empty($_SESSION["cart_item"])) {
                    if(in_array($productByCode_topping[0]["food_toppings_code"],array_keys($_SESSION["cart_item"]))) {
                        foreach($_SESSION["cart_item"] as $k => $v) {
                                if($productByCode_topping[0]["food_toppings_code"] == $k) {
                                    if(empty($_SESSION["cart_item"][$k]["quantity"])) {
                                        $_SESSION["cart_item"][$k]["quantity"] = 0;
                                    }
                                    $_SESSION["cart_item"][$k]["quantity"] += $_POST["quantity"];
        ...
        case "cancelorder":
            unset($_SESSION["cart_item"]);
                    ...
                    header("location:00order_list.php");
                ...
                foreach($_SESSION['cart_item'] as $key => $value){
                    ...
                    if ($cart > 0) {
                        while ($rowsearch= mysqli_fetch_array($search)) {
                            ...
                            if($rowsearch['code'] = $code){ 
                                    $code_new =$rowsearch['code'];
                                    $search_code=mysqli_query($connect,"SELECT * FROM cart_item WHERE `order_code` = '$order_code' AND `code` = '$code' ");
                                    $rowsearch_code= mysqli_fetch_array($search_code);
        
                            
                                    $quantity_2 = $rowsearch_code['quantity'];
                                    $quantity_new = $quantity_2 + $quantity;
        
                                    $sql_search_upnew=  mysqli_query($connect, "UPDATE cart_item SET quantity ='$quantity_new'
                                                                    WHERE code = '$code_new'  AND `order_code`='$order_code' ")
                                                                    or die('query failed');
                            }
                            ...
                            $sql = mysqli_query($connect, "INSERT INTO cart_item(code, quantity, price, order_code) 
                            VALUES('$code','$quantity','$price','$order_code')") 
...
*/
                    ...
                    $total_sum_u = mysqli_query ($connect, "SELECT quantity, price, SUM(quantity*price) as total_sum_u FROM cart_item WHERE `order_code` = '$order_code ' ");
                    $row = mysqli_fetch_array($total_sum_u);
                    $total_sum = $row['total_sum_u']; //     
                    
                    $total_quantity= mysqli_query ($connect, "SELECT quantity, SUM(quantity) as quantity FROM cart_item WHERE `order_code` = '$order_code ' ");
        ...
        <div  id="id01" class="modalid01">
            <div class="modal__content">
                ...
                <div class="modal-body">
                        <a class="a"  type="submit" href="00home2_list.php?exit"  >
...
<div class="tab">
                    ...
                    <div class="A">
                        ...
                        <div id="Menu" class="tabcontent">
                            <div  class="product">
                                ...
                                <?php
                                    $product_array = $db_handle->runQuery("SELECT * FROM food_item WHERE category_food ='0001' ");
                                    
                                    if (!empty($product_array)) { 
                                        foreach($product_array as $key=>$value){
                                ?>
                        
                                    <form method="post" action="00home2_list.php?action=add&code=<?php echo $product_array[$key]["food_menu_code"]; ?>">  
                    ...
                    <div class="A">
                        ...
                        <div id="Topping" class="tabcontent">
                            <div  class="product">
                                <?php
                                    $product_array = $db_handle->runQuery("SELECT * FROM food_item WHERE category_food ='0004' ");
                    ...
                    <div class="A">
                            ...
                            <div id="D2" class="tabcontent">
                                <div  class="product" >
                                    ...
                                    <?php
                                        $product_array = $db_handle->runQuery("SELECT * FROM food_item WHERE category_food ='0002' ");
                        ...
                        <div class="A">
                            ...
                            <div id="D3" class="tabcontent">
                                <div  class="product" >
                                    ...
                                    <?php
                                        $product_array = $db_handle->runQuery("SELECT * FROM food_item WHERE category_food ='0003' ");
                    ...
                    <div class="total-sum-list">
                                <div class="list">
                                    <div class="list-box" id="listbox">
                                        ...
                                        -->
                                        <a class="btnEmpty Empty" id="btnEmpty" href="00home2_list.php?action=empty">Empty Cart</a>
                                        <a  class="btnEmpty cancelorder" href="00home2_list.php?action=cancelorder">ยกเลิกการเพิ่มออเดอร์</a>
                                        ...
                                        <div class="list-item">
                                            ...
                                            <div class="del">
                                                <a class="btn-trash"   href="00home2_list.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction" ><i class='bx bxs-trash-alt'></i></a>  
                                            </div>                                           
                                        </div>  
                                        <?php
                                        ...
                                        ?> 
                                                ...
                                                <div class="list-control">
                                                        ...
                                                        -->
                                                        <button class="btn btn-danger">
                                                        <a id="btnEmpty" href="00home2_list.php?action=order"><?php  $total_quantity_sum ?>จัดการออเดอร์</a>                                           
                                                        </button>
