                        ...
                        <div id="Menu" class="tabcontent">
                            <div  class="product">
                                ...
                                ?>
                                    ...
                                    <form method="post" action="01home2_user.php?action=add&code=<?php echo $product_array[$key]["food_menu_code"]; ?>">  
                    ...
                    <div class="total-sum-list">
                                <div class="list">
                                    <div class="list-box" id="listbox">
                                        ...
                                        -->
                                        <a class="btnEmpty Empty" id="btnEmpty" href="01home2_user.php?action=empty">Empty Cart</a>
                                        <a  class="btnEmpty cancelorder" href="01home2_user.php?action=cancelorder">ยกเลิกออเดอร์</a>
                                        ...
                                        <div class="list-item">
                                            ...
                                            <div class="del">
                                                <a class="btn-trash"   href="01home2_user.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction" ><i class='bx bxs-trash-alt'></i></a>  
                                            </div>                                           
                                        </div>  
                                        <?php
                                        ...
                                        ?> 
                                                ...
                                                <div class="list-control">
                                                        ...
                                                        -->
                                                        <button class="btn btn-danger">
                                                        <a id="btnEmpty" href="01home2_user.php?action=order"><?php  $total_quantity_sum ?>จัดการออเดอร์</a>                                           
                                                        </button>
