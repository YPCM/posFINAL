...
<div class="boxx">   
    ...
    <div class="boxS" >
               ...
               ?>
                <div class="receipt_2">
                    <div class="namere" style="font-weight: bold;" >ประวัติการขาย</div>
                    <div class="receiptno"> <p>เลขที่ใบเสร็จ : </p> <p style="padding-left: 10px; "><?php echo "#".$receipt ; ?></p> </div>
                                ...
                                <table >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 80%; ">ชื่อเมนูอาหาร</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: end;"><?php echo number_format($priceXquantity,2) ;?></td>
                                        </tr>
                                        <?php } } ?>
                                    </tbody>
                                    <tbody>
                                        <tr>
                                            <td colspan="3" style="text-align: center;">ราคารวม</td>
