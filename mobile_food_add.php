...
<div class="w3-main w3-content w3-padding " style="max-width:1200px;margin-top:90px;">
    ...
    <div class="boxcontent" >
        ...
        <div id="A1" class="tabcontent">
            <div class="product">
                    ...
                    ?>
                <form method="post" action="mobile_food_add.php?action=add&code=<?php echo $product_array[$key]["food_menu_code"]; ?>">  
                    <div class="AAA0">
                       <div class="p">
    ...
    <div class="panel" >
        ...
        <div class="listfooditem"> 
            ...
            <a class="fooditem_nameC" href="mobile_food_add.php?action=remove&code=<?php echo $item["code"]; ?>">ลบ</a>
        </div>
        <?php
  ...
  <div class="fooditem_name_total">จำนวน <?php echo $total_quantity ."&nbsp";?> รายการ</div>
    ...
    <div class="footer1">
        <div class="btnfooter">
            <a class="btn_00" href="mobile_food_add.php?action=order">จัดออเดอร์</a>
        </div>
    </div>
    <div class="footer2">
        <div class="btnfooter">
            <a class="btn_00" href="mobile_food_add.php?action=cancelorder" >ยกเลิกเมนูอาหาร</a>
        </div>
    </div>
  <!--  <div class="footer3">
        <div class="btnfooter">
