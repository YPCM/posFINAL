...
-->
            ...
            <div class="boxtable">
                ...
                ?>
                                ...
                                <tr valign="baseline" >
                                <td style="text-align: center; font-weight: bold ; text-decoration: none;"> <?php echo '<a style="text-decoration: none; "name="order_code" type="submit" href="00order.php?order_code='.$row0["order_code"].' ">'.$id_number.'</a> '?> </td>
