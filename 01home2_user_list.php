        ...
        case "add_topping":
            if(!empty($_POST["quantity"])) {
                ...
                $itemArray = array($productByCode_topping[0]["food_toppings_code"]=>array('name'=>$productByCode_topping[0]["toppings_name"], 
                                                                                        ...
                                                                                        'price_1'=>$productByCode_topping[0]["toppings_price"], 
        ...
        <div  id="id01" class="modalid01">
            <div class="modal__content">
                ...
                <div class="modal-body">
                        <a class="a"  type="submit" href="01home2_user_list.php?exit"  >
                        ...
                        <div id="Menu" class="tabcontent">
                            <div  class="product">
                                ...
                                ?>
                                    ...
                                    <form method="post" action="01home2_user_list.php?action=add&code=<?php echo $product_array[$key]["food_menu_code"]; ?>">  
                    ...
                    <div class="total-sum-list">
                                <div class="list">
                                    <div class="list-box" id="listbox">
                                        ...
                                        -->
                                        <a class="btnEmpty Empty" id="btnEmpty" href="01home2_user_list.php?action=empty">Empty Cart</a>
                                        <a  class="btnEmpty cancelorder" href="01order_list_user.php?action=cancelorder">ยกเลิกการเพิ่มออเดอร์</a>
                                        ...
                                        <div class="list-item">
                                            ...
                                            <div class="del">
                                                <a class="btn-trash"   href="01home2_user_list.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction" ><i class='bx bxs-trash-alt'></i></a>  
                                            </div>                                           
                                        </div>  
                                        <?php
                                        ...
                                        ?> 
                                                ...
                                                <div class="list-control">
                                                        ...
                                                        -->
                                                        <button class="btn btn-danger">
                                                        <a id="btnEmpty" href="01home2_user_list.php?action=order"><?php  $total_quantity_sum ?>จัดการออเดอร์</a>                                           
                                                        </button>
